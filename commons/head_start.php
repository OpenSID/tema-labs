...
<meta name='theme' content='LABS V.0.2' />
<meta name='designer' content='Nazrul Rahim' />
<meta name='theme:designer' content='Labkoding.id Nazrul Rahim' />
<meta name='theme:version' content='v.0.2' />
...
<title><?php  if ($single_artikel["judul"] == "")    echo $this->setting->website_title  . ' ' . ucwords($this->setting->sebutan_desa)  . (($desa['nama_desa']) ? ' ' . $desa['nama_desa'] : '');  else echo $single_artikel["judul"]. ' - ' . ucwords($this->setting->sebutan_desa)  . (($desa['nama_desa']) ? ' ' . $desa['nama_desa'] : ''); ?>                  
</title>
